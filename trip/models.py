...
# trips table and notes(images) table
...
class Note(models.Model):
    ...
    # we will use module pillow that handles images and go to settings.py and setup some settings in the bottom and urls.py
