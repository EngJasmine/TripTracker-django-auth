...
from .views import HomeView, trips_list, TripCreateView, TripUpdateView, TripDeleteView, TripDetailView, NoteDetailView, NoteListView, NoteCreateView, NoteDeleteView, NoteUpdateView
